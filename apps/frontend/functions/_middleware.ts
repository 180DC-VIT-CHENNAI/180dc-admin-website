...
function addSecurityHeaders(headers: Headers) {
  ...
  headers.set(
    ...
    "default-src 'self'; script-src 'self' https://static.cloudflareinsights.com https://*.clerk.accounts.dev https://*.clerk.dev https://cdn.clerk.com https://clerk.vitc-180dc.org; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; img-src 'self' data: https://180dc.org https://static.cloudflareinsights.com https://*.clerk.accounts.dev https://*.clerk.dev https://cdn.clerk.com; connect-src 'self' https://admin-api.technical-vitc.workers.dev wss://admin-api.technical-vitc.workers.dev https://cloudflareinsights.com https://*.clerk.accounts.dev https://*.clerk.dev https://cdn.clerk.com https://clerk.vitc-180dc.org https://raw.githubusercontent.com https://gist.githubusercontent.com; font-src 'self' https://fonts.gstatic.com; frame-src 'self' https://*.clerk.accounts.dev https://*.clerk.dev https://clerk.vitc-180dc.org; worker-src 'self' blob: https://*.clerk.accounts.dev https://*.clerk.dev; frame-ancestors 'none'; base-uri 'self'",
  );
