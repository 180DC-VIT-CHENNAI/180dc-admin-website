function addSecurityHeaders(headers: Headers) {
  ...
  headers.set(
    ...
    "default-src 'self'; script-src 'self'; style-src 'self' 'unsafe-inline'; img-src 'self' data:; connect-src 'self' https://*.180dc.org https://180dc-admin-api.*; font-src 'self'; frame-ancestors 'none'; base-uri 'self'",
  );
