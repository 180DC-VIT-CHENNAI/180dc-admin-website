function addSecurityHeaders(headers: Headers) {
  ...
  headers.set(
    ...
    "default-src 'self'; script-src 'self' https://static.cloudflareinsights.com; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; img-src 'self' data: https://180dc.org https://static.cloudflareinsights.com; connect-src 'self' https://*.180dc.org https://*.180dc.shop https://api.180dc.shop wss://api.180dc.shop https://admin-api.technical-vitc.workers.dev wss://admin-api.technical-vitc.workers.dev https://raw.githubusercontent.com https://gist.githubusercontent.com https://cloudflareinsights.com; font-src 'self' https://fonts.gstatic.com; frame-ancestors 'none'; base-uri 'self'",
  );
